...
// No TypeScript, no tsconfig — pure Node.js + @solana/web3.js

const { PublicKey } = require('@solana/web3.js');

const programId = new PublicKey('4yXwSNTTQNAArrvxfwTB3fE2WPiePZbADzDqHQSsPttz');
...
// Run 4 — restore to single seed → must match Run 1
...
console.log('\nRun 1 === Run 4 (determinism check):', pda1.toBase58() === pda4.toBase58() ? '✅ MATCH' : '❌ MISMATCH');
